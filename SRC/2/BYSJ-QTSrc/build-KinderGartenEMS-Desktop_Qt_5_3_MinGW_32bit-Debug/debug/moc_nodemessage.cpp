...
#include "../../KinderGartenEMS/nodemessage.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_nodeMessage_t, stringdata) + ofs \
...
const QMetaObject nodeMessage::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_nodeMessage.data,
      qt_meta_data_nodeMessage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_nodeMessage.stringdata))

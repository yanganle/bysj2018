...
//#define DEVICE_SHAKE		  0x07	//震动
//#define DEVICE_DS18B20        0x08	//温度
//#define DEVICE_PH             0x09	//PH值
#define DEVICE_WATERLEVEL	  0x0A	//水位

//#define DEVICE_FAN            0x10  //风扇
//#define DEVICE_LAMP           0x11  //LED灯光
//#define DEVICE_SL_ALARM		  0x12  //声光报警
#define DEVICE_WATER_PUMP     0x13	//水泵
#define DEVICE_WATER_VALVE    0x15	//水阀
...
public:
    ...
    SensorRevData()          //默认构造函数
        :dataheadh(0xee),dataheadl(0xcc),netid(0),nodechannel(0),connectport(0),datalenth(0),sensortype(0),dataend(0xff){};
    //复制构造函数

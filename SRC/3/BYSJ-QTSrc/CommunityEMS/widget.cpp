    ...
    ui(new Ui::Widget)
{
    ...
    this->setWindowTitle(QString::fromLocal8Bit("社区环境监控系统"));
    ...
    connect(navWidget,SIGNAL(pm25check(double)),this,SLOT(recevicePM25data(double)));
}
Widget::~Widget()
{
    delete ui;
...
void Widget::recevicePM25data(double data)
{
    QString sensorData;
    ui->pm25label->setText(sensorData.setNum(data));
}

...
public:
    ...
    void setupUi(QWidget *homeForm)
    {
        ...
        lamptvaluelabel = new QLabel(groupBox_4);
        lamptvaluelabel->setObjectName(QStringLiteral("lamptvaluelabel"));
        lamptvaluelabel->setGeometry(QRect(170, 60, 41, 21));
        ...
        pm25Statelabel = new QLabel(groupBox_3);
        ...
        label_20->setGeometry(QRect(160, 50, 51, 31));
        pm25Number = new QLCDNumber(groupBox_3);
        pm25Number->setObjectName(QStringLiteral("pm25Number"));
        pm25Number->setGeometry(QRect(60, 50, 91, 31));
        pm25Button = new QPushButton(groupBox_3);
    ...
    void retranslateUi(QWidget *homeForm)
    {
        ...
        groupBox_5->setTitle(QApplication::translate("homeForm", "\347\224\262\351\206\233", 0));
        ...
        lamptvaluelabel->setText(QString());
        groupBox_3->setTitle(QApplication::translate("homeForm", "\347\262\211\345\260\230", 0));
        ...
        label_20->setText(QApplication::translate("homeForm", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">PPM</span></p></body></html>", 0));

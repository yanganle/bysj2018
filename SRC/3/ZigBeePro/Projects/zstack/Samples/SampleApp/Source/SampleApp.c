...
#endif
#ifdef DEVICE_GAS_KB03 //污染传感器KB03甲醛
  gasvalue = ReadGasData();
  sdata[0] = 0;
  sdata[1] = 0;
  sdata[2] = gasvalue>>8;//高位
  sdata[3] = gasvalue;//低位
  SampleApp_Send_P2P_Message(DEVICE_GAS_KB03, 0, 0, sdata);
#endif
...
#endif
#ifdef DEVICE_PM25 //PM2.5
  //GetPM25Value();
  sdata[0] = 0;
  sdata[1] = 0;
  sdata[2] = 0;
  sdata[3] = 0;
  SampleApp_Send_P2P_Message(DEVICE_PM25, 0, 0, sdata);
#endif

...
public:
    ...
    void setupUi(QWidget *homeForm)
    {
        ...
        lampStatelabel = new QLabel(groupBox_5);
        lampStatelabel->setObjectName(QStringLiteral("lampStatelabel"));
        lampStatelabel->setGeometry(QRect(320, 35, 31, 16));
        ...
        lamppixlabel = new QLabel(groupBox_5);
        lamppixlabel->setObjectName(QStringLiteral("lamppixlabel"));
        lamppixlabel->setGeometry(QRect(60, 40, 81, 81));

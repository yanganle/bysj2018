...
unsigned char xiaoshu1=0;
unsigned char xiaoshu2=0;
unsigned char xiaoshu=0;
unsigned int svalue;//测量到的温度的整数部分
bit  fg=1;        //温度正负标志
unsigned char date;
...
{ 
	...
	svalue = tempL/16+tempH*16;      //整数部分
	xiaoshu1 = (tempL&0x0f)*10/16; //小数第一位
	xiaoshu2 = (tempL&0x0f)*100/16%10;//小数第二位
	xiaoshu=xiaoshu1*10+xiaoshu2; //小数两位
	
	tempstr[0]='0'+(svalue/10);
	tempstr[1]='0'+(svalue%10);
	tempstr[2]='.';
	tempstr[3]='0'+(xiaoshu1%10);
	tempstr[4]='C';
	tempstr[5]='\0';

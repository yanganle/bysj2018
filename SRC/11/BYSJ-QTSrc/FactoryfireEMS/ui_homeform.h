...
public:
    ...
    QFrame *line_4;
    QLabel *label_35;
    QLabel *coldStatelabel;
    QWidget *layoutWidget4;
    QVBoxLayout *verticalLayout_4;
    QLabel *label_16;
    QLabel *label_15;
    QLabel *label_13;
    QLabel *coldvaluelabel;
    QLabel *coldpixlabel;
    ...
    void setupUi(QWidget *homeForm)
    {
        ...
        pumpvaluelabel = new QLabel(groupBox_3);
        pumpvaluelabel->setObjectName(QStringLiteral("pumpvaluelabel"));
        pumpvaluelabel->setGeometry(QRect(180, 60, 41, 21));
        ...
        coldStatelabel = new QLabel(groupBox_6);
        coldStatelabel->setObjectName(QStringLiteral("coldStatelabel"));
        coldStatelabel->setGeometry(QRect(320, 35, 31, 16));
        ...
        coldvaluelabel = new QLabel(groupBox_6);
        coldvaluelabel->setObjectName(QStringLiteral("coldvaluelabel"));
        coldvaluelabel->setGeometry(QRect(170, 70, 41, 21));
        coldpixlabel = new QLabel(groupBox_6);
        coldpixlabel->setObjectName(QStringLiteral("coldpixlabel"));
        coldpixlabel->setGeometry(QRect(70, 40, 81, 81));
    ...
    void retranslateUi(QWidget *homeForm)
    {
        ...
        groupBox_5->setTitle(QApplication::translate("homeForm", "\347\203\237\351\233\276", 0));
        ...
        groupBox_3->setTitle(QApplication::translate("homeForm", "\346\260\264\346\263\265", 0));
        ...
        groupBox_6->setTitle(QApplication::translate("homeForm", "\345\210\266\345\206\267", 0));
        label_35->setText(QApplication::translate("homeForm", "\346\216\247\345\210\266", 0));
        coldStatelabel->setText(QApplication::translate("homeForm", "\347\246\273\347\272\277", 0));
        ...
        coldvaluelabel->setText(QString());
        coldpixlabel->setText(QString());

...
public:
    ...
    void setupUi(QWidget *homeForm)
    {
        ...
        hotStatelabel = new QLabel(groupBox_5);
        ...
        hotpixlabel = new QLabel(groupBox_5);
        hotpixlabel->setObjectName(QStringLiteral("hotpixlabel"));
        hotpixlabel->setGeometry(QRect(80, 30, 81, 81));
        hotvaluelabel = new QLabel(groupBox_5);
        hotvaluelabel->setObjectName(QStringLiteral("hotvaluelabel"));
        hotvaluelabel->setGeometry(QRect(180, 60, 41, 21));
        ...
        gridLayout_2->addWidget(groupBox_4, 3, 1, 1, 1);
        ...
        lightvaluelabel = new QLabel(groupBox_6);
        lightvaluelabel->setObjectName(QStringLiteral("lightvaluelabel"));
        lightvaluelabel->setGeometry(QRect(170, 70, 41, 21));
        lightpixlabel = new QLabel(groupBox_6);
        lightpixlabel->setObjectName(QStringLiteral("lightpixlabel"));
        lightpixlabel->setGeometry(QRect(70, 40, 81, 81));
        ...
        tempNumber->setGeometry(QRect(70, 30, 91, 31));
        tempspinBox = new QSpinBox(groupBox);
        tempspinBox->setObjectName(QStringLiteral("tempspinBox"));
        tempspinBox->setGeometry(QRect(120, 70, 42, 22));
        tempspinBox->setValue(35);
        label_4 = new QLabel(groupBox);
        label_4->setObjectName(QStringLiteral("label_4"));
        label_4->setGeometry(QRect(70, 70, 41, 20));
        label_17 = new QLabel(groupBox);
        label_17->setObjectName(QStringLiteral("label_17"));
        label_17->setGeometry(QRect(170, 30, 51, 31));
        ...
        tempspinBox1 = new QSpinBox(groupBox);
        tempspinBox1->setObjectName(QStringLiteral("tempspinBox1"));
        tempspinBox1->setGeometry(QRect(120, 100, 42, 22));
        tempspinBox1->setValue(35);
        label_10 = new QLabel(groupBox);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(70, 100, 41, 20));
    ...
    void retranslateUi(QWidget *homeForm)
    {
        ...
        groupBox_5->setTitle(QApplication::translate("homeForm", "\345\212\240\347\203\255\345\231\250", 0));
        label_33->setText(QApplication::translate("homeForm", "\346\216\247\345\210\266", 0));
        ...
        label_39->setText(QApplication::translate("homeForm", "\346\216\247\345\210\266", 0));
        ...
        lightvaluelabel->setText(QString());
        lightpixlabel->setText(QString());
        ...
        label_4->setText(QApplication::translate("homeForm", "\351\230\210\345\200\274\351\253\230\357\274\232", 0));
        ...
        label_10->setText(QApplication::translate("homeForm", "\351\230\210\345\200\274\344\275\216\357\274\232", 0));
    } // retranslateUi

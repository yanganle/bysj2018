    ...
    ui(new Ui::Widget)
{
    ...
    this->setWindowTitle(QString::fromLocal8Bit("牛棚环境监控系统"));
    ...
    connect(navWidget,SIGNAL(lightcheck(bool)),this,SLOT(receviceLightdata(bool)));
}
Widget::~Widget()
{
    delete ui;
...
void Widget::receviceLightdata(bool flag)
{
    if(flag)
    {
        ui->lightLabel->setText(QString::fromLocal8Bit("强光"));
    }else
    {
        ui->lightLabel->setText(QString::fromLocal8Bit("弱光"));
    }
}
